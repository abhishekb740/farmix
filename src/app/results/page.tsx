    ...
    <main className="flex flex-col items-center min-h-screen p-2 gap-2 bg-black text-white font-sans">
      <div className="w-full">
        ...
        <div className="flex flex-row items-center justify-between py-2" style={{ fontFamily: "Satoshi" }}>
          <div className="text-4xl hover:cursor-pointer pl-8" style={{ fontFamily: 'Ares' }} onClick={() => router.push("/")}>Farmix</div>
        ...
        <div className="w-full md:w-2/3 flex flex-col gap-2 h-full  ">
          <div className="flex flex-col justify-between rounded-3xl border border-white min-h-[15rem] bg-[url('/result-image.png')] bg-no-repeat bg-cover gap-12">
            {similarityData?.similarityScore ? <div className='flex flex-row justify-end'>
              <div className='flex flex-row text-sm bg-gradient-to-r from-[#FC00FF] to-[#7087D8] text-white rounded-full px-3 py-2 items-center gap-1 justify-center mr-2 mt-2 hover:cursor-pointer' onClick={() => {
                window.open(
                  `https://warpcast.com/~/compose?text=%F0%9F%8C%90%20My%20Digital%20Twin%20on%20Warpcast!%20%F0%9F%9A%80%0A%0ADiscovered%20something%20amazing!%20By%20comparing%20our%20owned%20digital%20assets%20and%20mutual%20connections,%20I%20have%20a%20similarity%20score%20of%20${similarityData?.similarityScore.toFixed(2)}%25%20with%20@${similarityData?.secondaryUsername}%20%0A%0AWant%20to%20find%20your%20own%20digital%20twin%20and%20see%20how%20similar%20you%20are%20with%20other%20users?%20Join%20Farmix%20now%20and%20explore%20the%20exciting%20world%20of%20digital%20assets!%0A%0Ahttps%3A%2F%2Ffarmix.online`,
                  "_blank",
                );
              }}>
                <div>
